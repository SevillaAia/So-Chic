    ...
    <>
      <section className="footer">
        <div className="footer-powered">
          <a
            href="https://www.ironhack.com/de-en?utm_source=google&utm_medium=organic&utm_campaign=23-10_LOC_eur_DE_clics_google_mybusiness_&utm_content=organic-content"
            target="_blank"
          >
